...
@section('content')
    ...
    <div class="container">
        ...
        <div class="card mt-3">
            <div class="row g-0">
                <div class="col-md-8">
                    <img src="https://static.salekit.vn/image/site/2120/blogs/nha-hang-the-pizza.jpg"
                        class="card-img recipe-img" alt="recipe image">
                </div>
                <div class="col-md-4 border-start">
                    ...
                    <form>
                        <div class="d-flex">
                            <input class="recipe-comment" type="text" class="form-control" ref="userComment"
                                id="userComment" placeholder="コメントをする">
